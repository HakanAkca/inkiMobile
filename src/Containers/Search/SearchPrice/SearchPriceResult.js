                ...
                <View style={{padding: 10, alignItems: 'center', justifyContent: 'center'}}>
                    {
                        this.props.navigation.state.params.data.map((l, i) => (
                            ...
                            l.price >= this.props.navigation.state.params.value  ?
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Booking', {data: l})} style={{padding: 10}}>
                                    <ListItem
                                        ...
                                        leftAvatar={
                                            <View>
                                                <Avatar
                                                    containerStyle={{borderTopLeftRadius: 10, borderBottomLeftRadius: 10, overflow: 'hidden', width: 90.27, height: 100}}
                                                    size={"large"}
                                        ...
                                        title={
                                            <View>
                                                <Text style={{'color': colors[i % colors.length], fontSize: 16}}>{l.name}</Text>
